...
**Design plan v2.1 (lean) · September 2026** — v2.1 adds rule M1 (flush screw heads) after the ST-3 review
...
| DIN rail | Separate TS35 clip printed on its side, bolted through the back holes |
...
| DIN clip | part (holder / din_clip), din_clip_w (20) | 5 |
...
| ST-5 | `uh_din.scad`, `dist/uniholder_customizer.scad`, README | Clip passes in its print orientation; single file renders the same as the multi-file version |
